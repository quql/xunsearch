...
<meta http-equiv="description" content="Fulltext Search for Demo, Powered by xunsearch/1.4.12 " />
  ...
  <div class="row">
    ...
    <div class="span12">
      ...
      <form class="form-search" id="q-form" method="get">
        ...
        <div class="condition" id="q-options">
          <label class="radio inline"><input type="radio" name="f" value="controller" <?php echo $f_controller; ?> />Controller</label>
    ...
    <div class="span12">
      ...
      <dl class="result-list">
        ...
        <dt>
          <a href="javascript:void(alert('pid: <?php echo $doc->id; ?>'));"><h4><?php echo $doc->rank(); ?>. <?php echo $search->highlight(htmlspecialchars($doc->controller)); ?> <small>[<?php echo $doc->percent(); ?>%]</small></h4></a>          
        </dt>
        <dd>
          <p><?php echo $search->highlight(htmlspecialchars($doc->power)); ?></p>
...
<footer>
  <div class="container">
    <p>(C)opyright 2011 - Demo search - 页面处理总时间：<?php printf('%.4f', $total_cost); ?>秒<br>
      Powered by <a href="http://www.xunsearch.com/" target="_blank" title="开源免费的中文全文检索">xunsearch/1.4.12</a></p>
  </div>
</footer>
